...
# python ncs_realtime_facedetection.py --graph graphs/mobilenetgraph --confidence 0.5 --display 1
...
CLASSES = ("background", "zc", "cyf", "zj", "abr", "sfp")
...
if args["display"] > 0:
	cv2.imwrite("fps.jpg", image_for_result)
